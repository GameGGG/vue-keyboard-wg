...
## Install:
    ...
    $ npm install --save vue-keyboard-wg
...
```
add layouts default value "['qwertyuiop|asdfghjkl|{upper}zxcvbnm{backspace}|{123:goto:1}{space:space}.{Go:custom}','1234567890|!@#$\"&*()|?^/[]:;%{backspace}|{ABC:goto:0}{space:space}.{custom:custom}']"

add iconfont {backspace} ==> iconfont   {upper} ==> iconfont
